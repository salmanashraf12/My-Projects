class Enigma:
    def __init__(self,re,r1,r2,r3,pb,kb):
        ...
        self.kb=kb
    def set_rings(self):
     ring1 = int(input("Enter ring setting for wheel 1: "))
     ring2 = int(input("Enter ring setting for wheel 2: "))
     ring3 = int(input("Enter ring setting for wheel 3: "))
     self.r1.set_ring(ring1)
     self.r2.set_ring(ring2)
     self.r3.set_ring(ring3)

    def set_key(self):
     key = input("Enter encryption key (3 uppercase letters): ").upper()
